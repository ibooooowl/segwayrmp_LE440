...
double LogitechWirelessConverter::GetTranslationalVelocity(const sensor_msgs::Joy& rJoyMessage)
{
  IsValid(rJoyMessage);
...
double LogitechWirelessConverter::GetRotationalVelocity(const sensor_msgs::Joy& rJoyMessage)
{
  IsValid(rJoyMessage);
...
bool LogitechWirelessConverter::GetDeadman(const sensor_msgs::Joy& rJoyMessage)
{
  IsValid(rJoyMessage);
...
int LogitechWirelessConverter::GetAudioCommand(const sensor_msgs::Joy& rJoyMessage)
{
  IsValid(rJoyMessage);
...
void  LogitechWirelessConverter::IsValid(const sensor_msgs::Joy& rJoyMessage)
{
